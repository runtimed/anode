...
/**
 * Convert PrivateUserData to GraphQL User format (includes email)
 * Only use for current user's own profile
 */
export function toGraphQLPrivateUser(userData: PrivateUserData) {
  return {
    id: userData.id,
