 ...
 */
export function getRunbookVanityUrl(ulid: string, title?: string | null): string {
 ...
 */
export function hasCorrectVanityUrl(currentPath: string, ulid: string, title?: string | null): boolean {
  ...
  return currentVanityPath === expectedPath || currentVanityPath === `${expectedPath}/`;
}
