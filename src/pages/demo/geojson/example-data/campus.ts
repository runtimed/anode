...
const freeBus: GeoJSON.FeatureCollection = {
...
const lightRailStop: GeoJSON.FeatureCollection = {
  type: "FeatureCollection",
  features: [
    {
      type: "Feature",
...
const bicycleRental: GeoJSON.FeatureCollection = {
  type: "FeatureCollection",
  features: [
    {
      geometry: {
...
export { freeBus, lightRailStop, bicycleRental, campus };
