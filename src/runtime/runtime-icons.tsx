...
export const PythonWasmIcon = ({ className }: { className?: string }) => (
...
export const PythonTerminalIcon = ({ className }: { className?: string }) => (
  <div className="relative">
    <PythonIcon className={className} />
    <Terminal className="absolute -right-1 -bottom-1 size-2.5 rounded-[2px] border-1 border-white bg-black text-white" />
  </div>
);
