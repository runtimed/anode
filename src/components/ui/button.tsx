    ...
    variants: {
      variant: {
        ...
        destructiveSecondary:
          "text-destructive bg-destructive/10 hover:bg-destructive/15 hover:text-destructive focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:hover:bg-destructive/20",
