...
var s = (e, t) => Q(e, "name", { value: t, configurable: !0 }),
  R = ((e) =>
    typeof require < "u"
      ? require
      : typeof Proxy < "u"
...
for (b = 0; b < w.length; b++)
  ((p.prototype["get" + E(w[b])] = O(w[b])),
    (p.prototype["set" + E(w[b])] = (function (e) {
      return function (t) {
        this[e] = !!t;
      };
    })(w[b])));
...
for (v = 0; v < N.length; v++)
  ((p.prototype["get" + E(N[v])] = O(N[v])),
    (p.prototype["set" + E(N[v])] = (function (e) {
      return function (t) {
...
for (h = 0; h < _.length; h++)
  ((p.prototype["get" + E(_[h])] = O(_[h])),
    (p.prototype["set" + E(_[h])] = (function (e) {
      return function (t) {
        this[e] = String(t);
      };
    })(_[h])));
...
async function T() {
  if (
    !g ||
    ((z = (await import("node:url")).default),
    (H = await import("node:fs")),
    (L = await import("node:fs/promises")),
    (V = (await import("node:vm")).default),
    (D = await import("node:path")),
    (U = D.sep),
    typeof R < "u")
  )
    return;
  let e = H,
    ...
    a = { fs: e, crypto: t, ws: o, child_process: r };
...
async function le(e) {
  (e.startsWith("file://") && (e = e.slice(7)),
    e.includes("://")
      ? V.runInThisContext(await (await fetch(e)).text())
      : await import(z.pathToFileURL(e).href));
}
s(le, "nodeLoadScript");
async function J(e) {
  if (g) {
    ...
    a = {
      ...
      getLocalSet: (n) => {
        ...
        for (; d.length; ) {
          let u = d.pop(),
            m = t.stat(u);
          (t.isDir(m.mode) && d.push.apply(d, t.readdir(u).filter(c).map(l(u))),
            (i[u] = { timestamp: m.mtime, mode: m.mode }));
        }
      ...
      loadLocalEntry: (n) => {
        ...
        if (t.isFile(l.mode))
          return (
            (c.contents = o.getFileDataAsTypedArray(c)),
      ...
      storeRemoteEntry: async (n, i, c) => {
        let l = n.get(r.dirname(i)),
          d = t.isFile(c.mode)
            ? await l.getFileHandle(r.basename(i), { create: !0 })
            : await l.getDirectoryHandle(r.basename(i), { create: !0 });
        if (d.kind === "file") {
      ...
      reconcile: async (n, i, c) => {
        ...
        (Object.keys(i.entries).forEach(function (f) {
          ...
          (!S ||
            (t.isFile(y.mode) &&
              y.timestamp.getTime() > S.timestamp.getTime())) &&
            (d.push(f), l++);
        }),
          d.sort());
        let u = [];
  ...
  return function (t) {
    ...
    try {
      ...
      (console.error(`Error occurred while making a home directory '${e}':`),
        console.error(r),
        console.error(`Using '${o}' for a home directory instead`),
        (e = o));
    }
    t.FS.chdir(e);
  };
...
function pe(e) {
  ...
  return async (o) => {
    ...
    (o.FS.mkdirTree("/lib"),
      (o.API.sitePackages = `/lib/python${r}.${a}/site-packages`),
      o.FS.mkdirTree(o.API.sitePackages),
      o.addRunDependency("install-stdlib"));
    try {
      let n = await t;
...
function ge(e) {
  ...
  return (
    ...
    [...me(e.fsInit), pe(t), ue(e.env.HOME), fe(e.env), Y]
  );
}
    ...
    return (
      (async function () {
        try {
          let n;
          o
            ? (n = await WebAssembly.instantiateStreaming(o, r))
...
async function $e(e = {}) {
  ...
  let a = G(r),
    n = a.API;
  if (
    ((n.lockFilePromise = J(r.lockFileURL)),
  ...
  if (e._loadSnapshot) {
    ...
    (ArrayBuffer.isView(f) ? (i = f) : (i = new Uint8Array(f)),
      (a.noInitialRun = !0),
      (a.INITIAL_MEMORY = i.length));
  }
  let c = await _createPyodideModule(a);
  if (a.exited) throw a.exited.toThrow;
  if (
    (e.pyproxyToStringRepr && n.setPyProxyToStringMethod(!0),
    n.version !== C && r.checkAPIVersion)
  )
    throw new Error(
      `Pyodide version does not match: '${C}' <==> '${n.version}'. If you updated the Pyodide version, make sure you also updated the 'indexURL' parameter passed to loadPyodide.`
    );
  c.locateFile = (f) => {
...
s($e, "loadPyodide");
export { $e as loadPyodide, C as version };
