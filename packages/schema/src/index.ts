...
/**
 * // TODO: Move this up into the UI client to track, it's unrelated to the schema
 *
 * Safe MIME types are ones that are safe to render directly in the parent page.
 * And content that has the capability of running scripts is insafe. Some examples:
 * - text/html
 * - text/markdown
 * - svg
 *
